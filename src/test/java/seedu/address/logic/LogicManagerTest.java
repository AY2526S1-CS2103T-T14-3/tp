...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonFoodTrailStorage foodTrailStorage =
                new JsonFoodTrailStorage(temporaryFolder.resolve("addressBook.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(foodTrailStorage, userPrefsStorage);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonFoodTrailStorage foodTrailStorage = new JsonFoodTrailStorage(prefPath) {
            @Override
            public void saveFoodTrail(ReadOnlyFoodTrail foodTrail, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        Restaurant expectedRestaurant = (Restaurant) new RestaurantBuilder(AMY).withTags().build();
