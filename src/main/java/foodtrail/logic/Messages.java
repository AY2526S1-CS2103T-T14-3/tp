...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX = "The restaurant index provided is invalid";
    public static final String MESSAGE_PERSONS_LISTED_OVERVIEW = "%1$d restaurants listed!";
