...
public class FoodTrailParserTest {

    private final FoodTrailParser parser = new FoodTrailParser();

    @Test
    public void parseCommand_add() throws Exception {
        Restaurant restaurant = (Restaurant) new RestaurantBuilder().build();
    ...
    public void parseCommand_edit() throws Exception {
        Restaurant restaurant = (Restaurant) new RestaurantBuilder().build();
        EditRestaurantDescriptor descriptor = new EditRestaurantDescriptionBuilder(restaurant).build();
