...
public class Restaurant {
     ...
     */
    public boolean isSameRestaurant(Restaurant isSameRestaurant) {
        if (isSameRestaurant == this) {
            return true;
        }

        return isSameRestaurant != null
                && isSameRestaurant.getName().equals(getName());
    }
