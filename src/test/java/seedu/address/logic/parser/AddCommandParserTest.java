...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Restaurant expectedRestaurant = (Restaurant) new RestaurantBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Restaurant expectedRestaurantMultipleTags = (Restaurant) new RestaurantBuilder(BOB)
